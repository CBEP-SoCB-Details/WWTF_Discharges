...
Portland
Water District reports higher net reductions due to nitrogen optimization.  The
difference probably reflects the fact that our estimate of current mean
concentrations applies over the entire monitoring season , and thus
...
```{r tn_annual_stacked, fig.width = 3, fig.height = 3}
plt <- combined_summary %>%
...
```{r final_tn_annual_plot, fig.width = 2.9, fig.height = 3}
